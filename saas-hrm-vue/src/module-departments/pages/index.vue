<template>
  <div class="dashboard-container">
                  ...
                  <div class="treeRinfo">
                    <el-dropdown class="item">
                      ...
                      <el-dropdown-menu slot="dropdown">
                        ...
                        <el-dropdown-item>
                          <el-button type="text"
                                     @click="handleList()">查看待分配员工</el-button>
                        </el-dropdown-item>
                      </el-dropdown-menu>
                    </el-dropdown>
                  </div>
              ...
              <div class="generalClass"
                ...
                <span>
                  <i v-if="node.isLeaf"
                     class="fa fa-male"></i>
                  <i v-else
                     :class="node.expanded?'fa fa-minus-square-o':'fa fa-plus-square-o'"></i>
                  <span>{{ node.label }}</span>
                </span>
                <div class="fr">
                  <span class="treeRinfo">
                    <div class="treeRinfo">
                      <span>{{departData.depts.manage}}</span>
                      <span>在职 <em class="colGreen"
                            title="在职人数">72</em>&nbsp;&nbsp;(<em class="colGreen"
                            title="正式员工">40</em>&nbsp;/&nbsp;<em class="colRed"
                            title="非正式员工">32</em>)</span>
                    </div>
                    <div class="treeRinfo">
                      <el-dropdown class="item">
                        <span class="el-dropdown-link">
                        ...
                        <el-dropdown-menu slot="dropdown">
                          <el-dropdown-item>
                            <el-button type="text"
                                       @click="handlAdd(data.id)">添加子部门</el-button>
                          </el-dropdown-item>
                          <el-dropdown-item>
                            <el-button type="text"
                                       @click="handUpdate(data.id)">查看部门</el-button>
                          </el-dropdown-item>
                          <el-dropdown-item>
                            <el-button type="text"
                                       @click="handleList()">查看待分配员工</el-button>
                          ...
                          <el-dropdown-item>
                            <el-button type="text"
                                       @click="handDelete(data.id)">删除部门</el-button>
                          </el-dropdown-item>
                        </el-dropdown-menu>
                      </el-dropdown>
                    </div>
    ...
    <!--visible.sync是否展示-->
    <!--引入组件-->
    <component v-bind:is="deptAdd"
               ref="addDept"></component>
