              ...
              <el-form ref="formData"
                ...
                <el-row>
                  <el-col :span="12">
                    ...
                    <el-input v-model="userData.workNumber"
                              placeholder="请输入"
                              class="inputW"></el-input>
                  </el-col>
                  <el-col :span="12">
                    <span class="textR">入职时间：</span>
                    <el-date-picker v-model="userData.timeOfEntry"
                                    type="date"
                                    placeholder="选择日期"
                ...
                <el-row>
                  ...
                  <el-col :span="12">
                    <div>
                      ...
                      <input v-model="userData.departmentId"
                             class="inputW"
                             type="hidden">
                ...
                <el-row>
                  ...
                  <el-col :span="12">
                    ...
                    <el-select class="filter-item"
                               v-model="userData.formOfEmployment">
                      <el-option v-for="item in baseData.hireType"
                                 :key="item.id"
                                 :label="item.value"
                                 :value="item.id">
                      </el-option>
                ...
                <el-row>
                  <el-form-item class="formInfo"
                    ...
                    <div class="clearfix">
                      <RegShopImg :imgN='3'
                                  :imgs='userData.staffPhoto'
                                  ref="staffPhoto"></RegShopImg>
                    </div>
                    <span class="col999"
                          style="vertical-align: bottom;">图片格式为 JPG/JPEG/PNG/PDF 大小在2MB内</span>
                  </el-form-item>
                </el-row>
                <el-row :span="42">
                  <span class="textR"> </span>
                  <router-link :to="{'path':'/employees/index'}"
                               class="el-button el-button--default el-button--medium">返回</router-link>
                  <el-button type="primary"
                             @click="saveUserData()">保存更新</el-button>
                </el-row>
              </el-form>
            </div>
          </div>
        ...
        <div class="boxMain">
            ...
            <div class="mainInfo tabInfo"
              ...
              <el-form-item class="formInfo"
                ...
                <el-select v-model="formData.theHighestDegreeOfEducation"
                           placeholder="请选择">
                  <el-option v-for="item in baseData.highestDegree"
                             :key="item.value"
                             :label="item.label"
                             :value="item.value">
                  </el-option>
              ...
              <el-form-item class="formInfo"
                ...
                <el-select v-model="formData.nationalArea"
                           placeholder="请选择">
                  <el-option v-for="item in baseData.isOverseas"
                             :key="item.value"
                             :label="item.label"
                             :value="item.value">
                  </el-option>
              ...
              <el-form-item class="formInfo"
                ...
                <el-select v-model="formData.maritalStatus"
                           placeholder="请选择">
                  <el-option v-for="item in baseData.maritaStatus"
                             :key="item.value"
                             :label="item.label"
                             :value="item.value">
                  </el-option>
              ...
              <el-form-item class="formInfo"
                            label="属相：">
                <el-select v-model="formData.zodiac"
                           placeholder="请选择">
                  <el-option v-for="item in baseData.animalSymbol"
                             :key="item.value"
                             :label="item.label"
                             :value="item.value">
                  </el-option>
              ...
              <el-form-item class="formInfo"
                ...
                <el-select v-model="formData.constellation"
                           placeholder="请选择">
                  <el-option v-for="item in baseData.constellation"
                             :key="item.value"
                             :label="item.label"
                             :value="item.value">
                  </el-option>
              ...
              <el-form-item class="formInfo"
                ...
                <el-select v-model="formData.bloodType"
                           placeholder="请选择">
                  <el-option v-for="item in baseData.bloodType"
                             :key="item.value"
                             :label="item.label"
                             :value="item.value">
                  </el-option>
            ...
            <div class="mainInfo tabInfo"
              ...
              <el-form-item class="formInfo"
                ...
                <el-select v-model="formData.educationalType"
                           placeholder="请选择">
                  <el-option v-for="item in baseData.educationType"
                             :key="item.value"
                             :label="item.label"
                             :value="item.value">
                  </el-option>
          ...
          <div slot="footer"
            ...
            <router-link :to="{'path':'/employees/index'}"
                         class="el-button el-button--default el-button--medium">返回</router-link>
            <el-button type="primary"
                       @click="saveData('formData')">保存更新</el-button>
          </div>
        </div>
