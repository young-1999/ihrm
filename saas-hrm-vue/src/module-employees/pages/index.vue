    ...
    <div class="app-container">
      <el-card>
        ...
        <div class="fr">
          <router-link :to="{'path':'/employees/import/',query: {name: '员工'}}"
                       ...
                       v-if="show('POINT-USER-IMPORT')"
                       title="导入">导入</router-link>
          <el-button type="primary"
                     size="mini"
                     icon="el-icon-plus"
                     v-if="show('POINT-USER-ADD')"
      ...
      <el-card shadow="never"
        ...
        <el-table :data="dataList"
          ...
          <el-table-column fixed="right"
            ...
            <template slot-scope="scope">
              ...
              <el-button v-if="show('USER-ROLE-ASSIGNMENT')"
              ...
              -->
              <el-button v-if="show('API-USER-DELETE')"
        ...
        <component v-bind:is="employeesAdd"
                   ref="addUser"
                   @doQuery="doQuery"></component>
        <!--分配角色组件 -->
        <component v-bind:is="addRole"
                   ref="addRole"></component>
        <!-- 转正 -->
        <component v-bind:is="employeesPositive"
                   ref="positive"></component>
      </el-card>
    </div>
  </div>
</template>
