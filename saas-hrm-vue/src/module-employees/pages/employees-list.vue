    ...
    <div class="app-container">
      <el-card>
        ...
        <div class="fr">
          ...
          <router-link :to="{'path':'/employees/report/'+ totals.month}"
                       class="el-button el-button--primary el-button--mini">{{totals.month}}月份报表</router-link>
        </div>
      </el-card>
      <el-card shadow="never"
        ...
        <el-form :inline="true"
              ...
              <el-col :span="6">
                <el-form-item label="性别：">
                  <el-radio-group v-model="requestParameters.gender">
                    <el-radio v-for="item in baseData.gender"
                              :label="item.value"
                              :key="item.id"
                              :value="item.value">
                      {{item.value}}
              ...
              <el-col :span="6">
                <el-form-item label="聘用形式：">
                  <el-radio-group v-model="requestParameters.formOfEmployment">
                    <el-radio v-for="item in baseData.hireType"
                              :label="item.value"
                              :key="item.id"
                              :value="item.value">
                      {{item.value}}
              ...
              <el-col :span="6">
                <el-form-item label="管理形式：">
                  <el-radio-group v-model="requestParameters.formOfManagement">
                    <el-radio v-for="item in baseData.subjection"
                              :label="item.value"
                              :key="item.id"
                              :value="item.value">
                      {{item.value}}
              ...
              <el-col :span="6">
                <el-form-item label="账号状态：">
                  <el-radio-group v-model="requestParameters.accountStatus">
                    <el-radio v-for="item in common.enableState"
                              :label="item.value"
                              :key="item.id"
                              :value="item.value">
                      {{item.value}}
              ...
              <el-col>
                <el-form-item label="部门：">
                  <el-radio-group v-model="requestParameters.department">
                    <el-radio v-for="item in baseData.departments"
                              :label="item.value"
                              :key="item.id"
                              :value="item.value">
                      {{item.value}}
              ...
              <el-col>
                <el-form-item label="工作城市：">
                  <el-radio-group v-model="requestParameters.workingCity">
                    <el-radio v-for="item in baseData.isOverseas"
                              :label="item.value"
                              :key="item.id"
                              :value="item.value">
                      {{item.value}}
          ...
          <div class="showMore"
            ...
            <el-form-item>
              ...
              <el-button type="text"
                         @click="toggleShowMore">{{ showMore ? '收起▲' : '展开▼'}}</el-button>
            </el-form-item>
          </div>
        </el-form>
        ...
        <el-table :key='tableKey'
          ...
          <el-table-column fixed="right"
            ...
            <template slot-scope="scope">
              ...
              <el-button @click="handlPositive(scope.row.id)"
                         type="text"
        ...
        <!-- 转正 -->
        <component v-bind:is="employeesPositive"
                   ref="positive"
                   :objInfoDataes='objInfoDataes'
                   :formData.sync='requestParameters'
                   :text='text'
                   :pageTitle='pageTitle'
                   :formBase='formData'
        ...
        <!-- 设置 -->
        <component v-bind:is="employeesSet"
                   ref="set"
                   :objInfoDataes='objInfoDataes'
                   :formData.sync='requestParameters'
                   :setData='setData'
