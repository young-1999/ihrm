        ...
        <div>
          <div class="infoTip">
            <div v-if="this.$route.query.name === '员工'">
              ...
              <el-alert title="每次导入仅可添加1000名员工，姓名、手机、入职时间、聘用形式为必填项"
                        type="warning"
                        show-icon
                        :closable="false">
              </el-alert>
            ...
            <div v-if="this.$route.query.name === '考勤'">
              ...
              <el-alert title="如果某员工已有打卡记录，最新上传的不覆盖原有数据。可上传多名员工的打卡记录。每名员工可上传多条记录，同考勤日内取员工第一次和最后一次打卡时间。"
                        type="warning"
                        show-icon
                        :closable="false">
              </el-alert>
  ...
  data () {
    return {
      ...
      baseData: {
        ...
        fileUrl: 'https://pan.baidu.com/s/1p8MO3atDBevyqpyiTG9k2Q?pwd=qg99'
      }
    }
  },
  methods: {},
