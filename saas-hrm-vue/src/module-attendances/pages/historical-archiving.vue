    ...
    <div class="historicalTable">
      ...
      <div class="itemes"
        ...
        <div class="itemTopLab"
          ...
          <div>
            <p class="title"
               ref="sheelName">{{itemes.archiveYear}}-{{itemes.archiveMonth}}月员工报表</p>
        ...
        <div class="itemDropDown"
             v-show="itemes.act">
          <el-alert title="迟到、早退和补签的统计单位为“次”；所有假期类型、外出、旷工的统计单位均为“天”。"
                    type="warning"
                    :closable="false"
                    show-icon></el-alert>
          <div class="topLab">
          ...
          <el-table :data="contentData"
            ...
            <el-table-column prop="atteSolution"
                             label="当月考勤方案"
                             width="200"></el-table-column>
            ...
            <el-table-column prop="workCity"
                             label="工作城市"
                             width="200"></el-table-column>
            <el-table-column prop="leaveDays"
                             label="事假"
                             width="100"></el-table-column>
            <el-table-column prop="dayOffLeaveDays"
                             label="调休"
                             width="100"></el-table-column>
            <el-table-column prop="normalDays"
                             label="正常"
                             width="100"></el-table-column>
            <el-table-column prop="laterTimes"
                             label="迟到次数"
                             width="100"></el-table-column>
            <el-table-column prop="earlyTimes"
                             label="早退次数"
                             width="100"></el-table-column>
            <el-table-column prop="hoursPerDays"
                             label="日均时长（自然日）"
                             width="150"></el-table-column>
            <el-table-column prop="hoursPerWorkDay"
                             label="日均时长（工作日）"
                             width="150"></el-table-column>
            <el-table-column prop="hoursPerRestDay"
                             label="日均时长（休息日）"
                             width="150"></el-table-column>
            <el-table-column prop="clockRate"
                             label="打卡率（%）"
                             width="120"></el-table-column>
            <el-table-column prop="absenceDays"
                             label="旷工天数"
                             width="100"></el-table-column>
            <el-table-column prop="isFullAttendanceint"
                             label="是否全勤"
                             width="100"></el-table-column>
            <el-table-column prop="actualAtteUnofficialDays"
                             label="实际出勤天数（非正式）"
                             width="180"></el-table-column>
            <el-table-column prop="actualAtteOfficialDays"
                             label="实际出勤天数（正式）"
                             width="180"></el-table-column>
            <el-table-column prop="workingDays"
                             label="应出勤工作日"
                             width="120"></el-table-column>
            <el-table-column prop="salaryStandards"
                             label="计薪标准"
                             width="100"></el-table-column>
            <el-table-column prop="salaryAdjustmentDays"
                             label="计薪天数调整"
                             width="120"></el-table-column>
            <el-table-column prop="workHour"
                             label="工作时长"
                             width="100"></el-table-column>
            <el-table-column prop="salaryUnofficialDays"
                             label="计薪天数（非正式）"
                             width="150"></el-table-column>
            <el-table-column prop="salaryOfficialDays"
                             label="计薪天数（正式）"
                             width="150"></el-table-column>
          </el-table>
          <!-- 分页 -->
