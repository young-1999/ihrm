        ...
        <el-tab-pane label="出勤设置"
          ...
          <el-form ref="dataForm"
            ...
            <el-form-item label="部门："
                          prop="departmentId">
              <el-select v-model="departmentData.name"
                         placeholder="请选择"
                         @change="handleChange">
            ...
            <el-form-item label="出勤时间："
              ...
              <el-time-select v-model="formBase.morningStartTime"
                ...
                step: '00:15',
                              ...
                              class="timePicker"></el-time-select>-
              ...
              <template slot-scope="scope">
                <div>
                  ...
                  <el-switch v-model="scope.row.isEnable"
                             ...
                             @change="handleStatus($event,scope.row)"></el-switch>
                </div>
                ...
                <div class="attentInfo"
                  ...
                  <p>
                    ...
                    <el-input v-model="scope.row.periodUpperLimit"
                              class="inputInfo"
                              value="30"
                              @input.native="handleInput($event)"></el-input>分钟
                  </p>
                  <div class="deductionInfo">
                    <p>
                      ...
                      <el-input v-model="scope.row.timesUpperLimit"
                                class="inputInfo"
                                @input.native="handleInput($event)"></el-input>次，每次扣款
                      <el-input v-model="scope.row.dedAmonutUpperLimit"
                                class="inputInfo"
                                @input.native="handleInput($event)"></el-input>元
                    </p>
                    <p>
                      迟到>
                  ...
                  <div class="deductionInfo">
                    <p>
                      ...
                      <el-input v-model="scope.row.absenceTimesUpperLimt"
                                class="inputInfo"
                                disabled></el-input>次，每次矿工
                      <el-input v-model="scope.row.absenceDays"
                                class="inputInfo"
                                @input.native="handleInputPoint($event)"></el-input>天
                    </p>
                  </div>
                </div>
                <div class="attentInfo"
                ...
                <div class="attentInfo"
                  ...
                  <p>
                    ...
                    <el-input v-model="scope.row.fineSalaryMultiples"
                              class="inputInfo"
                              @input.native="handleInput($event)"></el-input>倍工资处罚
                  </p>
                </div>
              </template>
            </el-table-column>
                      ...
                      <template>
                        <el-time-select v-model="item.ruleStartTime"
                              ...
                              step: '00:15',
                                        ...
                                        style="width:100px;"
                                        :disabled="item.isTimeOff===false"></el-time-select>
