  ...
  <div class="boxInfo">
    ...
    <el-table :key="tableKey"
      ...
      <el-table-column prop="earlyTimes"
                       label="早退次数"
                       width="100"></el-table-column>
      <el-table-column prop="averageDailyNaturalDays"
                       label="日均时长"
                       width="150"></el-table-column>
      <el-table-column prop="absenceDays"
                       label="旷工天数"
                       width="100"></el-table-column>
      <el-table-column prop="whetherItIsFullOfWork"
                       label="是否全勤"
                       width="100"></el-table-column>
      <el-table-column prop="actualAttendanceDaysAreOfficial"
                       label="实际出勤天数"
                       width="180"></el-table-column>
      <el-table-column prop="attendanceDay"
                       label="应出勤工作日"
                       width="120"></el-table-column>
      <el-table-column prop="salaryStandard"
                       label="计薪标准"
                       width="100"></el-table-column>
      <el-table-column prop="officialSalaryDays"
                       label="计薪天数"
                       width="150"></el-table-column>
    </el-table>
    <!-- 分页 -->
    ...
    <div class="butList">
      <el-tooltip class="item"
        ...
        <el-button type="primary"
                   @click="archivingReportForm">归档{{month}}月份报表</el-button>
      </el-tooltip>
      <el-tooltip class="item"
                  effect="dark"
                  content="开始做下月考勤"
                  placement="top-start">
        <el-button type="primary"
                   @click="createReportForm">新建报表</el-button>
      </el-tooltip>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    createReportForm () {
      ...
      let nextyear = nextMonth.datas
      this.requestParameters.atteDate = nextyear.substring(0, 6);
      this.$confirm(
        "新建报表会使得" +
        this.month +
